...
print(round(customer_two_total, 2))
print("---------------------------")

# customer three
customer_three_total = 0
customer_three_itemization = ""
customer_three_total += lovely_loveseat_price
customer_three_itemization += lovely_loveseat_description
customer_three_total += stylish_settee_price
customer_three_itemization += stylish_settee_description
...
print("Customer three total:")
print(round(customer_three_total, 2))